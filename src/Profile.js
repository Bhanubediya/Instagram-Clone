    ...
    <>
      <div className="  pt-5">
        <div className="d-inline-flex col-11 justify-content-around">
          <div>
            <h4 className="">
              <strong className="profile-nums1">bhanubediya</strong>
            </h4>

            <img className="shadow bg-light profile-image" src="https://media-exp1.licdn.com/dms/image/C4D03AQHHtyNXXtD-RQ/profile-displayphoto-shrink_200_200/0/1661835782254?e=1670457600&v=beta&t=12Pez6dpYk0KOiEu3_xU55u9CDFQARpmtuphfPz0gJo" alt="" />
          ...
          <div className="d-inline-flex col-7 justify-content-around pt-5">
            <div>
              <h4>
                <strong className="profile-nums">100</strong>
              </h4>
              <h5 className="profile-list1">Posts</h5>
            </div>
            <div>
              <h4 className="text-center">
                <strong className="profile-nums">1M</strong>
              </h4>
              <h5 className="profile-list1">Followers</h5>
            </div>
            <div>
              <h4 className="text-center">
                <strong className="profile-nums">0</strong>
              </h4>
              <h5 className="profile-list1">Following</h5>
            </div>
          </div>
        </div>
        <div className="bio w-100 pt-3">
              <ul   style={{ listStyle: "none" }}>
                <li className="bio-list">
                  <h6 className="text-dark bio-heading">
                ...
                <li className="bio-list" style={{ fontFamily: "sans-serif" }}>Proud to be an Indian</li>
                <li className="bio-list" style={{ fontFamily: "sans-serif" }}>Software Engineer👨‍💻</li>
                <li className="bio-list" style={{ fontFamily: "sans-serif" }}>Fitness Freak 💪</li>
                <li className="bio-list" style={{ fontFamily: "sans-serif" }}>Music lover🎵🎤🎧</li>
                <li className="bio-list" style={{ fontFamily: "sans-serif" }}>Funny & mysterious person u'll ever talk to.</li>
                <li className="bio-list" style={{ fontFamily: "sans-serif" }}>Born on 1 oct to win hearts💘✌️</li>
              </ul>
            </div>
        <div className=" text-center pt-5 profile-dashboard">
          <ul style={{ listStyle: "none", backgroundColor: "lightgray", borderRadius: "1.8rem" }}>
            <li className="pt-1">
              <strong className="profile-nums1">Professional dashboard</strong>
            </li>
            <li className="pb-1 text-black-50">
              <strong className="profile-nums" style={{ fontWeight: "600" }}>3M</strong> accounts reached in the last 30 days.
            </li>
          </ul>
        </div>
          ...
          <Link className="text-decoration-none text-dark">
            <div className="profile-edit">
              <p className="pt-2 pb-2">
                <strong className="profile-nums" style={{ fontWeight: "500" }}>Edit profile</strong>
              </p>
            </div>
          </Link>
          <Link className="text-decoration-none text-dark">
            <div className="profile-edit">
              <p className="pt-2 pb-2">
                <strong className="profile-nums" style={{ fontWeight: "500" }}>Contact</strong>
              </p>
            </div>
          </Link>
        </div>
        ...
        <div className="d-inline-flex text-center col-12 justify-content-around pt-5 pb-4">
          <div>
            <img className="shadow bg-light add-highlight"  src="https://th.bing.com/th/id/OIP.l3h08_kYBtGZCbzGU5dxqAAAAA?pid=ImgDet&rs=1" alt="" />
            <p className="pt-3 profile-nums1">Web UI Pro...</p>
          </div>

          <div>
            <img className="shadow bg-light  add-highlight"  src="https://i.pinimg.com/originals/3e/ee/90/3eee906eb4182477d868aa05c1673b8b.jpg" alt="" />
            <p className="pt-3 profile-nums1">Activity</p>
          </div>

          <div>
            <img className="shadow bg-light add-highlight"  src="https://i.ytimg.com/vi/vhGOGCHBVhE/maxresdefault.jpg" alt="" />
            <p className="pt-3 profile-nums1">World</p>
          </div>

          <div>
            <img className="shadow bg-light add-highlight"  src="https://i.ytimg.com/vi/RcXxpOEfIEM/maxresdefault.jpg" alt="" />
            <p className="pt-3 profile-nums1">Love</p>
          </div>

          <div>
            <i className="fa-solid fa-plus  shadow bg-light add-highlight " style={{ fontFamily: "serif", fontWeight: "100", color: "lightgray" }}></i>
            <p className="pt-3 profile-nums1">New</p>
          </div>
        </div>
        ...
        <table className="table  pt-5">
          <thead className="">
            <tr>
              ...
              <th scope="col" className="col-3">
                <div className="text-center">
                  <img src={require("./assests/reels.png")} className="reels" alt="" />
                </div>
              </th>
