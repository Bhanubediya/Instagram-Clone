      ...
      <nav className="navbar nav  sticky-top navbar-white bg-white " style={{ borderBottom: "0.01rem solid lightgrey" }}>
        <div className="col-4 text-center">
          <Link className="text-decoration-none" to={"/"}>
            <img className="" style={{ height: "3rem" }} src="https://logos-world.net/wp-content/uploads/2020/04/Instagram-Logo-2010-2013.png" alt="" />
          </Link>
        </div>
        <div className="col-4 ">
          <nav className="navbar navbar-white bg-white ">
            <form className="form-inline">
              {/* &#xF002; */}
              <input className="form-control  " onFocus={search} onBlur={search} style={{ borderRadius: "10px", width: "18rem", backgroundColor: "lightgrey", fontFamily: "revert-layer" }} type="search" placeholder=" Search" aria-label="Search" />
        ...
        <div className="col-4 d-inline-flex justify-content-around " style={{ paddingRight: "6rem" }}>
          <i className="fa-solid fa-house text-dark" style={{ fontSize: "1.8rem", cursor: "pointer" }}></i>
         <Link className="text-decoration-none text-dark" to={"/Message"}>
         <i className="fa-brands fa-facebook-messenger " style={{ fontSize: "1.8rem", cursor: "pointer" }}></i>
         </Link>
          <i className="fa-solid fa-square-plus " style={{ fontSize: "1.8rem", cursor: "pointer" }}></i>
          <i className="fa-regular fa-compass " style={{ fontSize: "1.8rem", cursor: "pointer" }}></i>
          <div className="notification ">
          {show === false && (
            <div className="notification " onClick={heart} heartClicked={false} style={{cursor:"pointer"}}>
              <i className="fa-regular fa-heart regular-heart" style={{ fontSize: "1.8rem"}}></i>

              <li className="text-danger badge">.</li>
            </div>
          )}
            {show === true && <i className="fa-solid fa-heart" onClick={heart} style={{ fontSize: "1.8rem", cursor: "pointer" }}></i>}
            ...
            {show && (
              <div data-spy="scroll" data-target="#list-example" data-offset="0" class="scrollspy-example">
                <div className="container heart-popup shadow-lg " id="list-example">
                  ...
                  <div className="d-inline-flex col-12 justify-content-around heart-info" id="navbar-example">
                    <div className="d-inline-flex col-11 flec-wrap ">
                      <img
         ...
         <div>
         <img className="shadow bg-light" onClick={myProfile} style={{ borderRadius: "50%", width: "1.8rem", height: "1.8rem" }} src="https://media-exp1.licdn.com/dms/image/C4D03AQHHtyNXXtD-RQ/profile-displayphoto-shrink_200_200/0/1661835782254?e=1670457600&v=beta&t=12Pez6dpYk0KOiEu3_xU55u9CDFQARpmtuphfPz0gJo" alt="" />
         {showprofile && 
